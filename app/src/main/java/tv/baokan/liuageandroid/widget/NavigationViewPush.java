package tv.baokan.liuageandroid.widget;
...
public class NavigationViewPush extends RelativeLayout implements View.OnClickListener {

    public NavigationViewPush(Context context) {
        this(context, null);
    }
    ...
    // 从布局文件加载会调用
    public NavigationViewPush(Context context, AttributeSet attrs) {
        super(context, attrs);
        View view = LayoutInflater.from(context).inflate(R.layout.navigation_view_push, this, true);
