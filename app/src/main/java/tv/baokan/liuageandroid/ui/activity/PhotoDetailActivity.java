...
public class PhotoDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void setupUI(ArticleDetailBean detailBean) {
        ...
        // 评论数量
        if (!detailBean.getPlnum().equals("0")) {
            mPlnumTextView.setVisibility(View.VISIBLE);
            ...
            public void onResponse(String response, int id) {
                ...
                try {
                    ...
                    if (jsonObject.getString("err_msg").equals("success")) {
                        ...
                        // 评论数量 + 1
                        int num = Integer.parseInt(mPlnumTextView.getText().toString());
                        mPlnumTextView.setText(num + 1 + "");
                        // 对文章进行修改后需要移除旧的缓存并重新缓存
                        NewsDALManager.shared.removeNewsDetail(classid, PhotoDetailActivity.this.id);
                    } else {
