...
public class RegisterActivity extends BaseActivity implements View.OnClickListener, TextWatcher {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNavigationViewRed = (NavigationViewPush) findViewById(R.id.nav_register);
        ...
        // 配置导航栏
        mNavigationViewRed.setupNavigationView(true, false, "注册", new NavigationViewPush.OnClickListener() {
            @Override
