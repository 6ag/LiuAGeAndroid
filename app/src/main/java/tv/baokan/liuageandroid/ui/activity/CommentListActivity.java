...
public class CommentListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNavigationViewRed = (NavigationViewPush) findViewById(R.id.nav_comment_list);
        ...
        mNavigationViewRed.setupNavigationView(true, false, "评论", new NavigationViewPush.OnClickListener() {
            @Override
                ...
                try {
                    ...
                    if (new JSONObject(response).getString("err_msg").equals("success")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            LogUtils.d(TAG, "commentBean = " + commentBean.toString());
                        }
