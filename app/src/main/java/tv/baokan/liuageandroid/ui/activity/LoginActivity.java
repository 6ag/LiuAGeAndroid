...
import tv.baokan.liuageandroid.widget.NavigationViewModal;
...
public class LoginActivity extends BaseActivity implements View.OnClickListener, TextWatcher {
    ...
    private NavigationViewModal mNavigationViewRed;    // 导航栏
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNavigationViewRed = (NavigationViewModal) findViewById(R.id.nav_login);
        ...
        // 配置导航栏
        mNavigationViewRed.setupNavigationView(true, false, "登录", new NavigationViewModal.OnClickListener() {
            @Override
    ...
    private void showShareSDKLogin(String platformString) {
        ...
        if (platform.isValid()) {
            ...
            if (!TextUtils.isEmpty(userId)) {
                String password = userId.length() >= 12 ? userId.substring(0, 12) : userId;
                String username = platformString.equals(Wechat.NAME) ? "wx_" + password : "qq_" + password;
        ...
        if (platformString.equals(QQ.NAME)) {
            // 网页
    ...
    private void shareSDKLoginhandler(String nickname, String avatar, String uid, final String platformName) {
        ...
        String username = platformName.equals(Wechat.NAME) ? "wx_" + password : "qq_" + password;
        username = username.toLowerCase();

        HashMap<String, String> parameters = new HashMap<>();
        parameters.put("username", username);
        parameters.put("password", password);
        parameters.put("email", username + "@6ag.cn");
