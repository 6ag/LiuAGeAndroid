...
public class ModifyInfoActivity extends BaseActivity {
    ...
    private void prepareUI() {
        mNavigationViewRed = (NavigationViewPush) findViewById(R.id.nav_modify_user_info);
        ...
        mNavigationViewRed.setupNavigationView(true, false, "修改资料", new NavigationViewPush.OnClickListener() {
            @Override
