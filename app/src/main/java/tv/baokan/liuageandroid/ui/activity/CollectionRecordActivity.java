...
public class CollectionRecordActivity extends BaseActivity {
    ...
    private void prepareUI() {
        mNavigationViewRed = (NavigationViewPush) findViewById(R.id.nav_collection);
        mRefreshLayout = (TwinklingRefreshLayout) findViewById(R.id.srl_collection_record_list_refresh);
        mNewsListRecyclerView = (RecyclerView) findViewById(R.id.rv_collection_record_list);
        mNavigationViewRed.setupNavigationView(true, false, "我的收藏", new NavigationViewPush.OnClickListener() {
            @Override
