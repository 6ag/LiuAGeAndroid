...
public class ArticleDetailBean {
    ...
    public static class ArticleDetailLinkBean {
        ...
        public ArticleDetailLinkBean(String classid, String id, String onclick, String title, String titlepic, String titleurl, String isurl, String classname) {
        ...
        ArticleDetailLinkBean(JSONObject linkArticle) {
            try {
                ...
                titleurl = linkArticle.getString("titleurl");
                isurl = linkArticle.getString("isurl");
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }
